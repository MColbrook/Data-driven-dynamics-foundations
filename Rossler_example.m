...
ODEFUN = @(t,y) [-y(2)-y(3);y(1)+0.1*y(2);0.1+y(3).*(y(1)-14)];
...
%% Rossler attractor
figure
plot3(PX1(1:M),PX2(1:M),PX3(1:M),'.r','markersize',15)
view(gca,[3.7779   17.9883]);
xlabel('$x$','interpreter','latex','fontsize',18)
ylabel('$y$','interpreter','latex','fontsize',18)
zlabel('$z$','interpreter','latex','fontsize',18)
exportgraphics(gcf,'rossler_attractor.png');



%%
figure
plot(PX1(1:4000),'k','linewidth',2)
axis off
exportgraphics(gcf,'rossler_series.png');
...
exportgraphics(gcf,'rossler_error.png');
...
exportgraphics(gcf,'rossler_pseudospectra.png');
